...
const AnalysisResultScreen = () => {
    ...
    if (colorTone == 'cool summer') {
        imageSource = require('/assets/cool-summer.jpg');
        ...
        imageSource = require('/assets/cool-winter.jpg');
        ...
        imageSource = require('/assets/warm-autumn.jpg');
        ...
        imageSource = require('/assets/warm-spring.jpg');
