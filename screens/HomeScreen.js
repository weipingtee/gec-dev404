            ...
            <View style={styles.topSection}>
                ...
                <View style={styles.storeInfo}>
                    ...
                    <View style={styles.storeDetails}>
                        ...
                        <View style={styles.storeStatsContainer}>
                            <Text style={styles.storeStatsText}>
                                4.9 <Text style={styles.topTag}>Top</Text> store rating
                            </Text>
                            <Text style={styles.storeStatsText}>
                                4.8 <Text style={styles.topTag}>Top</Text> communication
                            </Text>
                            <Text style={styles.storeStatsText}>
                                97.7% <Text style={styles.topTag}>Top</Text> positive reviews
                            </Text>
                        </View>
                    </View>
                </View>
